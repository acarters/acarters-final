...
export default class LoggedInSnakeComponent extends Component 
{
    constructor(props)
    {
        super(props);
    ...
    determineClass(val)
    {
        ...
        else if(this.state.snakeHead === val)
        {
            ...
            {
                return "orangeSnakeHead";
            }
            else if(this.props.color === "blue")
            {
                return "blueSnakeHead";
            }
            else if(this.props.color === "pink")
            {
                return "pinkSnakeHead";
            }
            else if(this.props.color === "canes")
            {
                return "canesSnakeHead";
            }
            else if(this.props.color === "heels")
            {
                return "heelsSnakeHead";
            }
        }
    ...
    renderScore()
    {
        ...
        {
            return (<p className = "scoreCounter"> Score: {this.state.score} &nbsp;&nbsp;&nbsp;&nbsp; High Score: {this.props.highScore}</p>);
        }
    }
    renderLoggedIn()
    {
        if(!this.state.isLost)
       return (<p className = "loginState">Logged in as: {this.props.user.email}</p>);
    }
    render() 
    {
        let classes = [256];
